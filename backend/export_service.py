...
class ExportService:
    ...
    def generate_student_html_report(student_id: str, student_name: str, violations: List[Dict]) -> str:
        ...
        try:
            ...
            html_parts.append('<style>body{font-family:Arial,sans-serif;margin:40px}.header{text-align:center;border-bottom:3px solid #333;padding-bottom:20px;margin-bottom:30px}h1{color:#333}table{border-collapse:collapse;width:100%;margin:20px 0}th,td{border:1px solid #ddd;padding:12px;text-align:left}th{background-color:#e74c3c;color:white}.violation-image{max-width:300px;max-height:200px;border:2px solid #e74c3c;border-radius:5px;margin:10px 0}.violation-card{border:1px solid #ddd;padding:15px;margin:15px 0;border-radius:5px}</style>')
